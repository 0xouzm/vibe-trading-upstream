...
- **2026-09-20** 🔌 **IM channels can now be configured from the Web UI**: Settings edits every channel's fields with validate-before-save (a rejected change never touches disk), masked secrets, an optional connection test, and a per-channel hot apply with no restart ([#1519](https://github.com/HKUDS/Vibe-Trading/issues/1519), [#1520](https://github.com/HKUDS/Vibe-Trading/pull/1520)). DingTalk ships the first guided setup.
