...
- **2026-09-20** 🔌 **يمكن الآن إعداد قنوات المراسلة من واجهة الويب**: تتيح صفحة الإعدادات تحرير حقول كل قناة مع تحقق قبل الحفظ (أي تغيير مرفوض لا يلامس القرص)، وإخفاء الأسرار، واختبار اتصال اختياري، وتطبيقًا فوريًا لكل قناة دون إعادة تشغيل ([#1519](https://github.com/HKUDS/Vibe-Trading/issues/1519)، [#1520](https://github.com/HKUDS/Vibe-Trading/pull/1520)). وDingTalk هو أول قناة بإعداد موجّه.
