...
- **2026-09-20** 🔌 **Los canales de mensajería ya se configuran desde la interfaz web**: la página de Ajustes edita los campos de cada canal con validación antes de guardar (un cambio rechazado nunca toca el disco), secretos enmascarados, una prueba de conexión opcional y aplicación en caliente por canal sin reiniciar ([#1519](https://github.com/HKUDS/Vibe-Trading/issues/1519), [#1520](https://github.com/HKUDS/Vibe-Trading/pull/1520)). DingTalk estrena la configuración guiada.
