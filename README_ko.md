...
- **2026-09-20** 🔌 **이제 Web UI에서 IM 채널을 설정할 수 있습니다**: 설정 페이지에서 각 채널의 필드를 편집합니다——저장 전 검증(거부된 변경은 디스크에 기록되지 않음), 마스킹된 시크릿, 선택적 연결 테스트, 재시작 없는 채널별 핫 적용([#1519](https://github.com/HKUDS/Vibe-Trading/issues/1519), [#1520](https://github.com/HKUDS/Vibe-Trading/pull/1520)). DingTalk이 첫 번째 가이드 설정을 제공합니다.
